 ...
 * @author LongTran
 */
public class SignInM extends javax.swing.JFrame {

    /**
     * Creates new form SignInM
     */
    public SignInM() {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/Passsword.png"))); // NOI18N
        jPanel2.add(jLabel2);
    ...
    private void Remember(){
        try{
           ...
           String FindID = "select ID from account where Username = '"+txtUS.getText()+"' ";
            ResultSet rs = s.executeQuery(FindID);
            if(rs.next()){
                String ID = rs.getString(1);  
               // System.out.println(ID);
                if(ckRe.isSelected()){
                    String sql = "Update remember set Username = '"+txtUS.getText()+"', Password = '"+txtPW.getText()+"', Status = 'Yes' where ID = '"+ID+"'";
                    s.executeUpdate(sql);
    ...
    private String Name(){
        ...
        try{
           con = Connect.connect();
           String sql = "Select FullName from infomem where Username = '"+txtUS.getText()+"'";
        ...
        try{
            ...
            if(txtUS.getText().equals("") ||txtUS.getText().equals("Username")){
                ...
                Homepage hg = new Homepage();
                    ...
                    hg.setVisible(true);
                    hg.lbName.setText(Name());
                    hg.lbUS.setText(txtUS.getText());
                    this.dispose();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
      ...
      try{
           ...
           String sql = "Select * from remember where Status = 'Yes'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignInM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
